...
<head>
    ...
    <!-- Bootstrap -->
    <link href="frontend_assets/css/bootstrap.min.css" rel="stylesheet">
    <!-- Bootstrap responsive -->
    <link href="frontend_assets/css/bootstrap-responsive.min.css" rel="stylesheet">
    <!-- Font awesome - iconic font with IE7 support -->
    <link href="frontend_assets/css/font-awesome.css" rel="stylesheet">
    <link href="frontend_assets/css/font-awesome-ie7.css" rel="stylesheet">
    <!-- Bootbusiness theme -->
    <link href="frontend_assets/css/boot-business.css" rel="stylesheet">
</head>
<body>
<!-- Start: HEADER -->
<header>
                    ...
                    <div class="active item">
                        <div class="hero-unit">
                            <div class="row-fluid">
                                ...
                                <div class="span5">
                                    <img src="frontend_assets/img/placeholder.jpg" class="thumbnail">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row-fluid">
            <ul class="thumbnails">
                <li class="span4">
                    <div class="thumbnail">
                        <img src="frontend_assets/img/placeholder-360x200.jpg" alt="product name">
                        <div class="caption">
                            <h3>Product name</h3>
                            <p>
...
<!-- End: FOOTER -->
<script type="text/javascript" src="frontend_assets/js/jquery.min.js"></script>
<script type="text/javascript" src="frontend_assets/js/bootstrap.min.js"></script>
<script type="text/javascript" src="frontend_assets/js/boot-business.js"></script>
</body>
</html>
